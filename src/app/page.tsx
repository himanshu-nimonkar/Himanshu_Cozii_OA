...
const MarsVisitForm = () => {
  ...
  // Memoize validateForm to prevent unnecessary re-renders
  ...
  }, [formData, step]); // Depend on formData and step to validate correctly

  // Validate form on step change
  useEffect(() => {
    const isValid = validateForm();
    setIsFormValid(isValid);
  }, [step, formData, validateForm]); // Trigger validation when step or formData changes
